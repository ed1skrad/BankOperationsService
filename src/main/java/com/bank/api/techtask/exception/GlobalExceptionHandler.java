...
import com.bank.api.techtask.domain.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDeleteException(
            HttpServletRequest request, DeleteException exception) {
        logger.error("DeleteException occurred!");
        ErrorResponse errorResponse =
                new ErrorResponse("Something error occurred with user credentials!", HttpStatus.BAD_REQUEST);
        return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
    }
