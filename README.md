...
## Schema
![db](https://github.com/ed1skrad/BackOperationService/blob/main/image/db.jpg)

## Swagger
![swagger](https://github.com/ed1skrad/BackOperationService/blob/main/image/swagger.jpg)
